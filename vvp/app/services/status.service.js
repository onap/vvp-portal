...
(function () {
    ...
    angular.module('ice.services.status', [])

        .service('statusService', ['$http', '$q', 'cacheService', function ($http, $q, cacheService) {
        	
            var urls = cacheService.get("configuration").urls;

            this.get = function (engagement) {
                var deferred = $q.defer();
                $http.get(urls.status.get.replace('@engagement',engagement)).
