...
(function () {
    ...
    angular.module('ice.services.vfc', [])

        .service('vfcService', ['$http', '$q', 'cacheService', function ($http, $q, cacheService) {

            var urls = cacheService.get("configuration").urls;

            this.get = function (vfUuid) {
                var deferred = $q.defer();
                $http.get(urls.vfcs.get.replace('@vfUuid',vfUuid)).
